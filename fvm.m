function [result] = fvm(u, v, ro, gama, Lx, Ly, nx, ny, bounds, Su, Sp, Mnx, Mny)
...
[~, ~, result] = generateSeperateMatrices(Su .* (deltaX*deltaY), Sp .* deltaX*deltaY, allF, allD, nx, ny, Mnx, Mny, zeros(size(Su)));
