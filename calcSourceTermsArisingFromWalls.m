...
if types.ntype == 0
    USpout(end-1, 2:end-1) = -2*mu*deltaX/deltaY;
end
if types.stype == 0
    USpout(2, 2:end-1) = -2*mu*deltaX/deltaY;
end


if types.wtype == 0
    VSpout(2:end-1, 2) = -2*mu*deltaY/deltaX;
end
if types.etype == 0
    VSpout(2:end-1, end-1) = -2*mu*deltaY/deltaX;
end

if types.ntype == 1
    USpout(end-1, 2:end-1) =-2*mu*deltaX/deltaY;
    USuout(end-1, 2:end-1) = 2*mu*bounds.movingWallSpeed*deltaX/deltaY;
end
if types.stype == 1
    USpout(2, 2:end-1) =-2*mu*deltaX/deltaY;
    USuout(2, 2:end-1) = 2*mu*bounds.movingWallSpeed*deltaX/deltaY;
end

if types.wtype == 1
    VSpout(2:end-1, 2) =-2*mu*deltaY/deltaX;
    VSuout(2:end-1, 2) = 2*mu*bounds.movingWallSpeed*deltaY/deltaX;
end
if types.etype == 1
    VSpout(2:end-1, end-1) =-2*mu*deltaY/deltaX;
    VSuout(2:end-1, end-1) = 2*mu*bounds.movingWallSpeed*deltaY/deltaX;
end
